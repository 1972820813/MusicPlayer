...
public class PickerScrollView extends View {
    ...
    private List<RecommendPersonalBean> mDataList;
    /**
    ...
    public void setData(List<RecommendPersonalBean> datas) {
        mDataList = datas;
    ...
    private void moveHeadToTail() {
        RecommendPersonalBean head = mDataList.get(0);
        mDataList.remove(0);
        mDataList.add(head);
    }

    private void moveTailToHead() {
        RecommendPersonalBean tail = mDataList.get(mDataList.size() - 1);
    ...
    private void init() {
        timer = new Timer();
        mDataList = new ArrayList<RecommendPersonalBean>();
    ...
    private void drawData(Canvas canvas) {
        ...
        String textData = mDataList.get(indexs).getCustomerName();
    ...
    public interface onSelectListener {
        void onSelect(RecommendPersonalBean pickers);
    }
}